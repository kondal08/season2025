...
@Setter
@Getter
public class IntakeCoralSubsystem extends GenericVoltageRollerSystem<IntakeCoralSubsystem.IntakeCoralGoal> {
  @RequiredArgsConstructor
  @Getter
  public enum IntakeCoralGoal implements VoltageGoal {
  ...
  @Setter private IntakeCoralGoal goal = IntakeCoralGoal.IDLING;
  private Debouncer currentDebouncer = new Debouncer(0.25, DebounceType.kFalling);

  public IntakeCoralSubsystem(String name, IntakeCoralIO io) {
    super(name, io);
  }

  public BooleanSupplier hasCoral() {
    return ()->(goal == IntakeCoralGoal.FORWARD
