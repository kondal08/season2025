...
public class AutoCommands {
  public static void registerAutoCommands(Superstructure superstructure) {
    ...
    /** Subsystem commands */
    NamedCommands.registerCommand("L4 Score", Commands.sequence(
    ...
    NamedCommands.registerCommand("Coral Station Intake Elevator", superstructure.setSuperStateCmd(SOURCE));
